...
for ((i=0; i<NUM_GPUS; i++)); do
    ...
    CMD="source /home/user/.virtualenvs/infiniteyou/bin/activate && CUDA_VISIBLE_DEVICES=$i python3 data_generator.py --celeb_hq_root /group-volume/Aman-Contents/data/CelebHQRefForRelease \
